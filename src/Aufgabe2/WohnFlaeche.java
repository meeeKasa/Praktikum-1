...
Die Villa hat 3 Etagen. Es soll gelten: x2 = 2 * x4 und x1 = 5 * x3.

Sie sind sich jedoch noch unsicher, welche Größe Ihre Villa haben soll.

Daher schreiben Sie ein Java-Programm, das mögliche Längen
für x1 und x2 in Metern über die Tastatur einliest und in Abhängigkeit dieser Werte die Wohnfläche berechnet.

Außerdem soll das Programm ausgeben,
wie teuer ein Rundweg um Ihre Villa wird, wenn pro Meter mit Kosten von 175,- € zu rechnen ist.
(Alles in Java !)
 */
...
import java.util.Scanner;
    ...
    public class WohnFlaeche {
        public static void main(String[] args) {
            ...
            // Ergebnisse ausgeben
            System.out.println("Die Wohnfläche Ihrer Villa beträgt: " +
